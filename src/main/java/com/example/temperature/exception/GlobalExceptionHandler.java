...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        if (ex.getBindingResult().getFieldErrors().stream().anyMatch(this::isRecordsMaxSizeViolation)) {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        UnrecognizedPropertyException unknownField = findCause(ex, UnrecognizedPropertyException.class);
        if (unknownField != null) {
            List<ErrorDetailResponse> details = List.of(
                    new ErrorDetailResponse(unknownField.getPropertyName(), "Unknown field is not allowed")
            );
            log.warn("Unknown JSON field rejected: {}", unknownField.getPropertyName());
            return build(HttpStatus.UNPROCESSABLE_ENTITY, "VALIDATION_ERROR", "Request validation failed", details);
        }

        log.warn("Malformed or unreadable request body", ex);
        return build(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "Malformed or invalid JSON request body", List.of());
    }
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        return build(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "Missing required query parameter", details);
    }
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
        ...
        return build(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "UNSUPPORTED_MEDIA_TYPE", "Unsupported media type", List.of());
    }
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        return build(HttpStatus.NOT_FOUND, "NOT_FOUND", "API path does not exist", List.of());
    }
    ...
    public ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex) {
        ...
        List<ErrorDetailResponse> details = List.of(new ErrorDetailResponse(field, field + " has an invalid value"));
        log.warn("Query parameter type mismatch: {}", field);
        return build(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "Invalid query parameter", details);
    }
    ...
    public ResponseEntity<Object> handleConversionFailed(ConversionFailedException ex) {
        ...
        return build(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "Invalid query parameter", List.of());
    }
    ...
    public ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex) {
        ...
        return build(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "Invalid request parameters", details);
    }
    ...
    public ResponseEntity<Object> handleInvalidQueryParameter(InvalidQueryParameterException ex) {
        ...
        return build(HttpStatus.BAD_REQUEST, "BAD_REQUEST", ex.getMessage(), ex.getDetails());
    }
    ...
    public ResponseEntity<Object> handleStorageUnavailable(StorageUnavailableException ex) {
        ...
        return build(HttpStatus.SERVICE_UNAVAILABLE, "SERVICE_UNAVAILABLE", "Storage is temporarily unavailable", List.of());
    }
